...
namespace Pathfinding {
	...
	public partial class AIPath {
		 ...
		 * \deprecated Use #cappedSpeed instead
		 */
		[System.Obsolete("This member has been deprecated. Use 'cappedSpeed' instead. [AstarUpgradable: 'speed' -> 'cappedSpeed']")]
		public float speed { get { return cappedSpeed; } set { cappedSpeed = value; } }
