...
public class Hitscan : Firearm {
    ...
    public override int Shoot() {
        ...
        //Store hit
        RaycastHit2D hit = Physics2D.Raycast(firePointPosition, mousePosition - firePointPosition + randomizer, 100, whatToHit);
        ...
        if (Time.time >= timeToSpawnEffect) {
            ...
            if (hit.collider == null) {
                hitPos = (mousePosition - firePointPosition + randomizer) * 30;
